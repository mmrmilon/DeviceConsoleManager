...
namespace DeviceConsoleManager.Controllers
{
    ...
    [ApiController]
    public class AccountRechargeApiController : ControllerBase
    {
        private readonly IAccountRechargeRepository repository;
        private readonly IHostingEnvironment hostingEnvironment;

        public AccountRechargeApiController(IAccountRechargeRepository repository, IHostingEnvironment hostingEnvironment)
        {
        ...
        [HttpPost]
        [Route("Save")]
        public ActionResult Save(AccountRecharge model)
        {
        ...
        [HttpPost]
        [Route("Update")]
        public ActionResult Update(AccountRecharge model)
        {
